                ...
                <div class="col-12">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select name="kode_klasifikasi" class="form-control">
                                                                    ...
                                                                    <option value="{{ $classification->kode }}">{{
                                                                        $classification->nama }}</option>
                                                                    @endforeach
                                                                </select>
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select name="kode_klasifikasi" class="form-control">
                                                                    <option value="">--Pilih Klasifikasi--</option>
                                                                    @foreach($classifications as $classification)
                                                                    <option value="{{ $classification->kode }}" {{ $d->
                                                                        kode_klasifikasi == $classification->kode
                                                                        ? 'selected' : '' }}>
                                                                        {{ $classification->nama }}
                                                                    </option>
                                                                    @endforeach
                    ...
                    <div class="modal fade" id="modal-detail{{ $d->id }}">
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h4 class="modal-title"><i class="fas fa-solid fa-file mr-2"></i>Detail Surat Masuk
                                    </h4>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                ...
                                <div class="modal-body">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td colspan="2"><strong>Nomor Agenda</strong> ( <span
                                                                id="detail_nomor_agenda">{{ $d->no_agenda }}</span> )
                                                        </td>
                                                    </tr>
                                                    <tr>
                                    ...
                                    <div class="mt-3">
                                        <table class="table table-bordered">
                                            <tbody>
                                                <tr>
                                                    <td colspan="2" class="bg-info text-white"><strong>Informasi Detail
                                                            Surat</strong></td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a id="detail_file"
                                                            href="{{ asset('uploads/surat_masuk/' . $d->file_surat) }}"
